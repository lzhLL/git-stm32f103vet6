...
//}DMA_InitTypeDef;
	...
	DMA_InitStruct.DMA_DIR = DMA_DIR_PeripheralSRC;	//从源开始传送
	DMA_InitStruct.DMA_BufferSize = BUFFER_SIZE;	//32个数据
	DMA_InitStruct.DMA_PeripheralInc = DMA_PeripheralInc_Enable;//外设地址增长
	DMA_InitStruct.DMA_MemoryInc = DMA_MemoryInc_Enable;//存储器地址增长
	DMA_InitStruct.DMA_PeripheralDataSize = DMA_PeripheralDataSize_Word;//四个字节的宽度
	DMA_InitStruct.DMA_MemoryDataSize = DMA_MemoryDataSize_Word;//存储器数据宽度为32位
